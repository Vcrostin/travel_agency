...
// MFC_travel.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCtravelApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCtravelApp

CMFCtravelApp::CMFCtravelApp()
{
...
// Единственный объект CMFCtravelApp

CMFCtravelApp theApp;


// Инициализация CMFCtravelApp

BOOL CMFCtravelApp::InitInstance()
{
